				...
				<div class="page-hero | wp-block-cover bg-white min-h-min  |  print:py-8">
					...
					<div class="wp-block-cover__inner-container p-2 container flex flex-col gap-0  |  lg:p-4">
						...
						<div class="text-neutral-900 flex flex-col justify-center space-y-6  |  md:min-h-hero print:min-h-min">
							<h1 class="text-neutral-900 leading-none tracking-light text-pretty shadow-neutral-50 drop-shadow-lg  |  lg:print:text-xl! print:text-black dark:text-neutral-100">
								<?php echo $page_title; ?>
							</h1>

							<h2 class="leading-none text-pretty text-neutral-700! shadow-neutral-50 drop-shadow-lg  |  md:max-w-5xl lg:print:text-base! print:text-black! dark:text-atlantis-200!"><?php echo $brand_message; ?></h2>
